...
import { 
  ...
  Home, Sparkles, Briefcase, TrendingUp
} from 'lucide-react';
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-brand-cream font-sans text-gray-800 selection:bg-brand-honey selection:text-brand-burgundy overflow-x-hidden">
      {/* Navigation */}
      <nav className={`fixed w-full z-40 transition-all duration-300 ${scrolled ? 'bg-brand-cream/95 backdrop-blur-md shadow-sm py-3' : 'bg-transparent py-5'}`}>
        <div className="container mx-auto px-6 flex justify-between items-center">
          <a href="#" className="flex items-center">
            <img 
              src="https://raw.githubusercontent.com/theyashsisodiya/aniamted-website/main/Ming%20Hwee%20Logo%20V1%20231221%20(1).png" 
              alt="MingHwee Logo" 
      ...
      <header className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden">
        ...
        <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          <motion.div style={{ opacity: heroOpacity, y: heroY }} className="space-y-6 max-w-xl">
            ...
            <h1 className="font-serif text-4xl md:text-6xl font-bold text-brand-burgundy leading-tight">
          ...
          >
            ...
            <div className="absolute -bottom-10 -left-10 w-48 bg-white p-4 rounded-2xl shadow-xl z-20 flex items-center gap-3 animate-bounce">
      ...
      <section id="employers" className="py-24 bg-brand-beige">
      ...
      {/* For Helpers Section */}
      <section id="helpers" className="py-24 bg-white relative overflow-hidden">
      ...
      {/* Stories Section */}
      <section id="stories" className="py-24 bg-brand-cream">
        <div className="container mx-auto px-6">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6 max-w-3xl">
          ...
          <div className="space-y-6">
            {FAQS.map((faq, i) => (
              <details key={i} className="group bg-gray-50 rounded-2xl p-6 [&_summary::-webkit-details-marker]:hidden open:bg-brand-cream transition-colors">
                <summary className="flex items-center justify-between cursor-pointer font-semibold text-gray-800">
                  {faq.question}
                  <span className="ml-4 transition-transform group-open:rotate-180">
                    <ArrowRight className="w-5 h-5 text-brand-terracotta rotate-90 group-open:rotate-[-90deg]" />
                  </span>
                </summary>
                <p className="mt-4 text-gray-600 leading-relaxed text-lg">{faq.answer}</p>
              </details>
            ))}
          </div>
        </div>
      ...
      {/* Call to Action */}
      <section className="py-24 bg-brand-terracotta text-white relative overflow-hidden">
